...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gel_barcode2_list", required=True, help="384 well plate 8bp list"
    )
    parser.add_argument(
        "--output_whitelist", required=True, help="final combinations whitelist"
    )

    args = parser.parse_args()

    process_plate_bcs(args.gel_barcode2_list, args.output_whitelist)
